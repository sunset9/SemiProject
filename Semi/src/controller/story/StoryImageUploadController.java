...
@MultipartConfig
public class StoryImageUploadController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 업로드될 파일 위치
        File uploads = new File(context.getRealPath("upload/story"));
...
//            linkName = path + "files/" + name;
            ...
            //업로드될 파일 위치+이름
            linkName ="http://localhost:8088/upload/story/"+name;
