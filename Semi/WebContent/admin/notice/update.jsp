...
<tr><td colspan="2"><textarea id="content" name ="content">${notice.content}</textarea></td></tr>

</table>

<c:if test="${noticeFile.origin_name ne null}">
<div id="fileSection"> 기존 첨부파일 : ${noticeFile.origin_name }<button id ="fileDelete" type="button">삭제</button></div><br>
</c:if>

<c:if test="${noticeFile.origin_name eq null}">
