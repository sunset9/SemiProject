...
<div>
<form action="/admin/qna/update"  method="post" enctype="multipart/form-data">
...
<tr><td class ="info">제목</td><td><input type="text"  name ="title" style="width:100%" value="${qna.title }"/></td></tr>
<tr><td class="info" colspan="2">본문</td></tr>
<tr><td colspan="2"><textarea id="content" name ="content">${qna.content}</textarea></td></tr>

</table>

<c:if test="${qnaFile.origin_name ne null}">
<div id="fileSection"> 기존 첨부파일 : ${qnaFile.origin_name }<button id ="fileDelete" type="button">삭제</button></div><br>
</c:if>

<c:if test="${qnaFile.origin_name eq null}">
